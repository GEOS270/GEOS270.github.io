...
Follow this [link](https://go.blueja.io/eRz_GDhRVEO1l9CLQ1Y2Wg) or:


![use this QR code](images/QRCode.png)

## About Evaluations

Teaching evaluations are completely anonymous and they not released to professors until after the final exam. If you’re curious what they look like on the professors’ end, you can see some of my evaluations from previous [here](https://github.com/June-Skeeter/june-skeeter.github.io/tree/main/Evaluations).
...
The final exam will be {{< var exam.type >}} and is scheduled for **`r tail(DueDates$Due.Date, 1)`**.

* One attempt - the exam submission window will be open for 24 hours.
...
This flowchart is missing one step and would get ~ 45/50 pts if submitted on the exam.

* Can you figure out what step is missing?
...
* Both NDIV Layers & DEM Layer >> Reproject (Albers)
* Reclassify >> NDVI, DEM, & Interpolated Temperature Data
